...
//               <button
//                 onClick={() => {
//                   if ((resume as any).resume_text) {
//                     handleCompare(resume.id, (resume as any).resume_text);
//                   } else {
//                     alert("No résumé text available for this file.");
//                   }
//                 }}
...
//       file_path: publicUrl,
//       is_default: false,
//       updated_at: new Date().toISOString(), // ensure date field is filled
//     });
...
//     setShowModal({ id: resumeId, visible: true }); // Open modal on result
//   } catch (err) {
//     console.error("Compare failed:", err);
//     alert("Something went wrong comparing this resume.");
//   }
...
//   const handleCompare = async (resumeId: string) => {
//     try {
//       const response = await fetch("http://localhost:5678/compare-resume", {
//         method: "POST",
//         headers: {
...
//         `Match Score: ${
//           result.matchScore
//         }%\nSkills Matched: ${result.matchedSkills?.join(", ")}`
//       );
//     } catch (error) {
...
//                 </button>
//                 <button
//                   onClick={() => handleCompare(resume.id)}
//                   className={`p-2 hover:text-green-600 transition-colors ${
//                     darkMode ? "text-gray-400" : "text-gray-600"
//                   }`}
//                   title="Compare Resume"
