...
// import { JobFilterState } from '../../types/jobs';
...
//   darkMode = false 
// }) => {
//   // Specific job categories that match your database search terms
//   const jobCategories = [
//     "software engineer",
//     "front-end developer",
//     "back-end developer",
...
//   const updateFilter = (key: keyof JobFilterState, value: string) => {
//     onFilterChange({
//       ...filters,
//       [key]: value
//     });
...
//         {/* Job Category Filter - Updated with specific categories */}
//         <select
//           value={filters.category}
