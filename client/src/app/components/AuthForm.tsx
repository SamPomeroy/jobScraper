...
// import { supabase } from "@/app/supabase/client"; // Make sure this uses createClientComponentClient()
...
//           {error && (
//             <div className="bg-red-50 border text-red-600 px-4 py-3 rounded-md text-sm">
//               {error}
//             </div>
//           )}
...
//               type="submit"
//               disabled={loading}
//               className="w-full flex justify-center py-2 px-4 text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:opacity-50"
//             >
